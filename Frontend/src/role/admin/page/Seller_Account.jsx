...
const Seller_Account = () => {
    ...
    return (
      <div className="p-5">
        <h3 className='text-start w-100 mb-4 border-bottom' style={{color: "#4A90E2"}}>Seller Accounts</h3>
              ...
              sellerdata.map((item, index) => {
                return (
                  <tr key={item._id} className="border-top mt-5">
                    ...
                    <td className="text-secondary"><img src={`http://localhost:5000/uploads/seller/${item?.image}`} alt="Auction Image" style={{ width: "80px", height: "80px", padding: "7px" }}/></td>
