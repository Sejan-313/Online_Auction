    ...
    return (
        ...
        <div className={`${css.container}`}>
            <div className={`${css.signup}`}>
                ...
                <div className={`${css.signup_link} border p-3 shadow-sm border-white text-center`}>
                    <p className="m-0 text-white">Don't have an account? <Link to="/signup_user" className="text-white">User</Link></p>
