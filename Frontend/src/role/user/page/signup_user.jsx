    ...
    return (
        ...
        <div className={`${css.container}`}>
            <div className={`${css.signup}`}>
                <div className={`${css.signup_form} border p-4 shadow-sm border-white`}>
                    <h4 className="text-center mb-3 font-weight-bold text-white">Sign Up</h4>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="d-flex justify-content-center"><button type="submit" className="btn border border-white text-white w-50">sign up</button></div>
                    </form>
                </div>

                <div className={`${css.signup_link} border p-3 shadow-sm border-white text-white text-center`}>
                    <p className="m-0 text-white">Don't have an account? <Link to="/signup_seller" className="text-white">Seller</Link></p>
                    <p className="m-0 text-white">Already have an account? <Link to="/login" className="text-white">Login</Link></p>
                </div>
            </div>
        </div>
        </>
