    ...
    return (
        <div >
            <form className={css['Add_Auction']} onSubmit={handleSubmit}>
                <h3 className='text-start w-100 mb-4 border-bottom border-white text-white'>Update Details</h3>
                ...
                <div className={css['Auction_Row_Btn']}>
                    <button type="submit" className="btn text-white w-50 text-center border border-white" style={{background: "transparent"}}>Add Auction</button>
                </div>
            </form>
        </div>
    )
