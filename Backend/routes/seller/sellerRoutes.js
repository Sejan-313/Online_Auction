...
const { createAuction,getAuction,deleteAuction,getAuctionreg,getAuctionsStatus,getAuctionById, updateAuction } = require("../../controllers/seller/auctionController");
